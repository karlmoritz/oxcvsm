...
// Created: 22-01-2013
// Last Update: Thu 03 Oct 2013 11:23:02 AM BST
...
void load_stanford::load(TrainingCorpus& trainCorpus, string file_positive,
    string file_negative, RecursiveAutoencoderBase& rae, bool add_to_dict,
    Senna& senna)
{
...
void load_stanford::load_file(TrainingCorpus& corpus, string file_name, RecursiveAutoencoderBase&
...
void load_stanford::createCCGInstance(CCGInstance& instance, xml_node& sentence, RecursiveAutoencoderBase& rae, bool add_to_dict, Senna& senna)
{
...
# endif
  ...
  // Fix tree counts
  for (int i=instance.rule.size()-1; i>=0; --i) {
