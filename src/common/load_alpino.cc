...
// Created: 22-01-2013
// Last Update: Thu 03 Oct 2013 11:24:43 AM BST
...
void load_alpino::load(TrainingCorpus& trainCorpus, string file_positive, string
...
void load_alpino::load_file(TrainingCorpus& corpus, string file_name, RecursiveAutoencoderBase&
...
void load_alpino::createCCGInstance(CCGInstance& instance, xml_node& sentence, RecursiveAutoencoderBase& rae, bool add_to_dict, Senna& senna)
{
